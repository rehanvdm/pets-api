    ...
    function Api() {
        ...
        _this.pets = {
            ...
            getPets: function (params) {
                ...
                return _this.request(__assign({ path: "/pets", method: "GET", format: "json" }, params));
            },
            /**
             * No description
             *
             ...
             * @request GET:/pets/{id}
             */
            getPetById: function (id, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/pets/".concat(id), method: "GET", format: "json" }, params));
            },
        };
        return _this;
    }
